...
public class Ship extends SpaceNode {
	...
	public void updateLife(int life) {
		...
		//visual damage.
		if(life < 350 && damage.getStage() != ShipDamage.DamageStage.LOW)
			damage.setStage(ShipDamage.DamageStage.LOW);
		if(life < 200 && damage.getStage() != ShipDamage.DamageStage.MEDIUM)
			damage.setStage(ShipDamage.DamageStage.MEDIUM);
		if(life < 200 && damage.getStage() != ShipDamage.DamageStage.MEDIUM)
			damage.setStage(ShipDamage.DamageStage.HIGH);
